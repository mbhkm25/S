    ...
    <div className="space-y-3">
      <section className="mx-2 rounded-2xl border border-slate-200 bg-white p-3 shadow-[0_8px_24px_rgba(15,23,42,0.04)] sm:mx-3">
        <button
          ...
          aria-label="فتح قسم الهوية البصرية والبيانات العامة"
        >
          ...
          <span className="min-w-0 flex-1">
            ...
            <strong className="mt-0.5 block text-xs text-slate-950">الهوية البصرية والبيانات العامة</strong>
            <span className="mt-1 block text-[9px] leading-5 text-slate-500">صورة البروفايل، صورة الغلاف، وصف النشاط وروابط التواصل.</span>
          </span>
