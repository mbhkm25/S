...
Canonical Library references at planning checkpoint: `SANAD.md` v1.4.7 (Library version 17), `SKILL.md` v0.3.0 (Library version 2), `ABU_SANAD.md` (Library version 11). Their mutable current versions must be checked again before the batch. Runtime, live Supabase/Edge and GitHub latest main remain implementation truth; accepted product ADR/roadmap is decision truth **only after review and merge**. Do not rewrite ABU_SANAD with operational/project facts.
