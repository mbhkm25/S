...
const pages = [
  ...
  },
  {
    ...
    description: 'تعرّف على سند Pro لإتاحة موسعة لمدة 30 يومًا، وإدارة الاشتراك وطلبات الدفع وسجل الاستخدام من حسابك في سند.',
    eyebrow: 'سند Pro',
    ...
    sections: [
      ['مدة محددة بوضوح', 'تعمل الباقة الحالية لمدة 30 يومًا من تاريخ بدايتها وفق البيانات المعروضة عند الاشتراك.'],
      ['إتاحة موسعة', 'توفر الخطة الحالية ما يصل إلى 1000 عملية تحقق خلال مدة الاشتراك، ولا تُرحّل العمليات غير المستخدمة بعد انتهائها.'],
